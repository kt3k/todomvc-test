...
var REMOVE_TEXT_KEY_SEQ = Array(51).join(
  webdriver.Key.BACK_SPACE + webdriver.Key.DELETE
)
...
module.exports = function Page (browser) {
  ...
  this.getMainSectionCss = function () {
    return classOrId + 'main'
  }

  this.getFooterSectionCss = function () {
    return 'footer' + classOrId + 'footer'
  }

  this.getClearCompletedButtonCss = function () {
    return 'button' + classOrId + 'clear-completed'
  }

  this.getNewInputCss = function () {
    return 'input' + classOrId + 'new-todo'
  }

  this.getToggleAllCss = function () {
    return 'input' + classOrId + 'toggle-all'
  }

  this.getItemCountCss = function () {
    return 'span' + classOrId + 'todo-count'
  }
  ...
  this.getFilterCss = function (index) {
    return (
      ...
      ') a, ' +
      classOrId +
      'filters a:nth-of-type(' +
      (index + 1) +
      ')'
    )
  }

  this.getSelectedFilterCss = function (index) {
    return this.getFilterCss(index) + '.selected'
  }

  this.getFilterAllCss = function () {
    return this.getFilterCss(0)
  }

  this.getFilterActiveCss = function () {
    return this.getFilterCss(1)
  }

  this.getFilterCompletedCss = function () {
    return this.getFilterCss(2)
  }

  this.getListCss = function (suffixCss) {
    return 'ul' + classOrId + 'todo-list' + (suffixCss || '')
  }

  this.getListItemCss = function (index, suffixCss, excludeParentSelector) {
    suffixCss =
      (index === undefined ? '' : ':nth-of-type(' + (index + 1) + ')') +
      (suffixCss || '')
    return excludeParentSelector
      ? 'li' + suffixCss
      : this.getListCss(' li' + suffixCss)
  }

  this.getListItemToggleCss = function (index) {
    return this.getListItemCss(index, ' input.toggle')
  }

  this.getListItemLabelCss = function (index) {
    return this.getListItemCss(index, ' label')
  }

  this.getLastListItemLabelCss = function (index) {
    return this.getListItemCss(index, ':last-of-type label')
  }

  this.getListItemInputCss = function (index) {
    return this.getListItemCss(index, ' input.edit')
  }

  this.getEditingListItemInputCss = function () {
    return this.getListItemCss(undefined, '.editing input.edit')
  }
  ...
  this.getListItemsWithCompletedStatesCss = function (completedStates) {
    var suffixCss =
      ' ' +
      completedStates
        .map(function (completed, i) {
          return this.getListItemCss(
            i,
  ...
  this.waitForElement = function (css, failMsg, timeout) {
    return browser.wait(
      until.elementLocated(webdriver.By.css(css)),
  ...
  this.waitForListItemCount = function (count) {
    ...
    return browser.wait(
      function () {
        return self
          .waitForElement(self.getListCss())
          .then(function (listElement) {
            return listElement.findElements(
              webdriver.By.css(self.getListItemCss(undefined, undefined, true))
            )
          })
  ...
  this.waitForVisibility = function (shouldBeVisible, css, failMsg) {
    if (shouldBeVisible) {
      return this.waitForElement(css, failMsg).then(function (element) {
        return browser.wait(
      ...
      return this.waitForElement(css, undefined, REMOVED_TIMEOUT)
        ...
        .then(function (elementOrError) {
          return elementOrError === ELEMENT_MISSING
            ...
            : browser.wait(
                until.elementIsNotVisible(elementOrError),
                DEFAULT_TIMEOUT,
                failMsg
              )
        })
  ...
  this.waitForMainSectionRemovedOrEmpty = function () {
    return this.waitForElement(
      ...
      .then(
        function (elementOrError) {
          return elementOrError === ELEMENT_MISSING
            ? ELEMENT_MISSING
            : this.waitForListItemCount(0)
        }.bind(this)
      )
  }

  this.waitForCheckedStatus = function (shouldBeChecked, failMsg, element) {
    var condition = shouldBeChecked
      ? 'elementIsSelected'
  ...
  this.ensureAppIsVisibleAndLoaded = function () {
    return this.waitForVisibility(
      false,
      this.getFooterSectionCss(),
      'Footer is not hidden'
    )
      .then(
        this.waitForElement.bind(
          this,
          '.new-todo, #new-todo',
  ...
  this.clickClearCompleteButton = function () {
    return this.waitForVisibility(
      true,
      this.getClearCompletedButtonCss(),
  ...
  this.enterItem = function (itemText) {
    ...
    return self
      ...
      .then(function (newItemInput) {
        return newItemInput.sendKeys(itemText).then(function () {
          return newItemInput
        })
      })
      .then(function (newItemInput) {
  ...
  this.editItemAtIndex = function (index, itemText) {
    return this.waitForElement(this.getListItemInputCss(index)).then(function (
      itemEditField
    ) {
